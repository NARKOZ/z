...
Object.extend(Dialog.Box.prototype,
{
	...
	{ 
		...
		if(this.options.fade_dialog)
		{
			...
			new Effect.Appear(this.dialog_box,
			{
				...
				before: function(effect)
				{
					/* must override this since the default function uses show() and will cause an endless loop */
				}
			});
		}
	},
	...
	{
		return document.viewport.getHeight() + document.viewport.getScrollOffsets().last();
	}
}); 
