...
callback:function(){z_engine_reply(c,a,j)}});if(f)i.addItem({label:'<img src="/img/lock.png" title="this account is private" alt="" />',enabled:false});else{i.addItem({label:function(){return'<img src="/img/rt.png" title="retweet" alt="" />'},condition:function(){return t},callback:function(){if(content_rts_stored[a])a=content_rts_stored[a].evalJSON(true).retweeted_status.id_str;z_engine_retweet(a);window.setTimeout(function(){if(content_rts_stored[a]){var u=content_rts_stored[a].evalJSON(true).id_str;
i.destroy();z_engine_tweet_right_click(u,b,c,screen_name,e,j,k,l,true,f,h)}},3500)}});i.addItem({label:function(){return'<span title="retweet (with comment, old method)">RT</span>'},condition:function(){return t},callback:function(){z_engine_retweet_comment(a,c,k)}});i.addItem({label:function(){return'<img src="/img/rtd.png" title="undo retweet" alt="" />'},condition:function(){return r},callback:function(){z_engine_destroy(a,"rt");i.destroy();z_engine_tweet_right_click(a,b,c,screen_name,e,j,k,l,
false,f,h)}})}l?i.addItem({label:'<img src="/img/favd.png" title="unfave" alt="" />',callback:function(){z_engine_unfavorite(a);i.destroy();z_engine_tweet_right_click(a,b,c,d,e,j,k,false,m,f,h)}}):i.addItem({label:'<img src="/img/fav.png" title="fave" alt="" />',callback:function(){z_engine_favorite(a);i.destroy();z_engine_tweet_right_click(a,b,c,d,e,j,k,true,m,f,h)}})}break;case "dms":i.addItem({label:function(){return'<img src="/img/rep.png" title="reply" alt="" />'},condition:function(){return q},
callback:function(){z_engine_reply_dm(e,c)}});i.addItem({label:'<img src="/img/del.png" title="delete" alt="" />',callback:function(){z_engine_destroy(a,"dm")}})}}function z_engine_unfavorite(a){socket.emit("message",{unfavorite:{status:{id_str:a}}})}function z_engine_update_relative_time(a){a=$$(a);a.length>0&&a.each(function(b){var c=b.getAttribute("datetime");b.update(relative_time(c))})};
