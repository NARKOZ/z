...
if(m){h=new Element("span");h.update(" in reply to ");u=new Element("a",{target:"_blank",href:"http://twitter.com/"+m});u.update(m+" ");l.insert(h);l.insert({bottom:u})}}if(r){r=new Element("span");r.update(" ");m=new Element("img",{src:"img/ver.png",alt:"",title:"verified user"});r.insert({bottom:m});l.insert({bottom:r})}G.insert(l);r=new Element("div",{"class":"right"});if(q){q=o>0?"retweeted by "+c+" and "+o+" others!":"retweeted by "+c+"!";o=new Element("span",{"class":"rtd"});o.update(" ");q=
